...
import { Agenda, WorldModel, ResonanceModule, SchemaMatcher, AttentionModule, GoalTreeManager } from '@cognitive-arch/types';
...
export class WorkerPool {
    ...
    public stop() {
        if (!this.running) return;
        this.running = false;
        logger.info("Stopping all workers in the pool...");
